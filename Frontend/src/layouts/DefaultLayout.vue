<template>
  <div class="site-layout">
    ...
    <footer class="site-footer">
      <div><BrandLogo compact :label="zh ? 'OpenPanda 首页' : 'OpenPanda home'" /><p>{{ zh ? '记录技术，也记录思考。' : 'Notes on building, learning, and thinking.' }}</p></div>
...
.site-footer p { margin-top: 8px; }.footer-links { display: flex; align-items: center; flex-wrap: wrap; gap: 16px; }
